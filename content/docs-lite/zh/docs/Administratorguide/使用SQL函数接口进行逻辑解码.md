...
-   逻辑日志目前从主机节点中抽取，如果进行逻辑复制，需要保证GUC参数[ssl](安全和认证_postgresql-conf.md#zh-cn_topic_0283137371_zh-cn_topic_0237124696_zh-cn_topic_0059778664_s8c4647db116f44c4b9ce3dceee3d6ffa)=on。
