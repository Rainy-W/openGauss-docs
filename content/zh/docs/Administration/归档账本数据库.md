...
-   账本数据库归档功能目前提供两种校验接口，分别为：[ledger\_hist\_archive\(text...](账本数据库的函数.md#li18806468138)和[ledger\_gchain\_archive\(vo...](../SQLReference/账本数据库的函数.md#li988064691317)。账本数据库接口仅审计管理员可以调用。
