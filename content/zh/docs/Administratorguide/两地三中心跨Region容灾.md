...
容灾搭建时需要对主备数据库实例发送搭建请求，参考《工具与命令参考》中gs\_sdr工具。
...
向灾备数据库实例发送灾备数据库实例升主的请求，参考《工具与命令参考》中gs\_sdr工具。
...
向主数据库实例发送容灾信息清除的请求，参考《工具与命令参考》中gs\_sdr工具。
...
向主备数据库实例发送计划内switchover的请求，参考《工具与命令参考》中gs\_sdr工具。

#### 查询主备数据库实例容灾状态<a name="ZH-CN_TOPIC_0000001262912023"></a>

向主备数据库实例发送容灾状态查询的请求，参考《工具与命令参考》中gs\_sdr工具。
