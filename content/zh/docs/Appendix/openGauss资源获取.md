...
-   文档 ：对openGauss数据库进行了描述，包括法律声明、发行说明、产品描述、技术白皮书、编译指导书、快速入门、安装指南、数据库管理、数据库运维、应用开发、内核开发、数据迁移、性能优化指南、工具与命令参考、AI特性指南、SQL参考等内容。全方位的介绍了openGauss的架构、功能、特性以及使用方法。文档中包含大量的示例，供您参考。
